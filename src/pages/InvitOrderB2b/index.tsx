            ...
            <S.Box>
               ...
               <S.BoxElement>
                  <S.BoxAvatar>
                     ...
                     <S.content>
                        <AntDesign name="caretright" size={RFValue(30)} />
                        <AntDesign name="caretleft" size={RFValue(30)} />
                     </S.content>
                  </S.BoxAvatar>

                  <S.office>
                     <S.ImageOfice source={{ uri: user?.profile?.logo }} />
                     <S.ImageOfice source={{ uri: prestador?.profile?.logo }} />
                  </S.office>
