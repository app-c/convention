   ...
   return (
      <Container>
         ...
         <Title>
            ...
            financeiros. Nosso projeto foi fundado em 13 de Janeiro de 2017,
            pelo Professor e Mentor corporativo Pedro Souza, atual presidente e
            desde então possui uma diretoria constituída que trabalha arduamente
            para implementar novidades constantemente no grupo. A partir do ano
            de 2019 até o presente momento já foram contabilizados mais de R$
            3.271.362,78 milhões em negócios gerados.
         </Title>
      </Container>
   );
}
